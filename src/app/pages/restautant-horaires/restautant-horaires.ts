  ...
  public service = inject(TableService);
     ...
     get_all_datas(){
      ...
      let restaurant_id = this.restaurantService.getRestaurant()
       this.crudSaasService.get_all_horaires(restaurant_id).subscribe({
         next: (res) => {
     ...
     redirect_add(){
       this.router.navigate(['/horaires/creer-horaire']);
     }
     ...
     modifier_data(id:number){
      if (!this.canEdit()) {
       ...
       this.router.navigate(['/horaires/modifier-horaire', id]);
     }
