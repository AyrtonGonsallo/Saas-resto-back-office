...
export class NavmenuService {
  ...
  MENUITEMS: Menu[] = [
...

    {
      id: 2,
      level: 1,
      title: 'Paramétrages réservations',
      icon: 'Setting',
      type: 'sub',
      active: false,
      children: [
        {
          ...
          path: '/horaires-reservation/liste-horaires-reservation',
...

    {
      id: 2,
      level: 1,
      title: 'Paramétrages Click & Collect',
      icon: 'Setting',
      type: 'sub',
      active: false,
      children: [
        {
          title: 'Horaires Click & Collect',
          path: '/horaires-click-and-collect/liste-horaires-click-and-collect',
          custom_icon_class: '<i class="icofont icofont-clock-time"></i>',
          icon: 'Home',
          roles: ['super-admin','gestionnaire-societe','admin','gestionnaire-restaurant','lecteur-planning','lecteur-cuisine','employé'],
          active: false,
    ...
    
    {
      ...
      custom_icon_class: '<i class="fas fa-shopping-cart"></i>',
      icon: 'Category',
      roles: [  'super-admin','admin', 'client', 'public',  'gestionnaire-restaurant', 'gestionnaire-societe', 'lecteur-planning', 'lecteur-cuisine',  'employé',   ],
      active: false,
    },
